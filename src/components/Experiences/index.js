    ...
    <>
      ...
      <Container>
        <CardContainer>
          ...
          <CardDescription>
            Montagem e manutenção de computadores, suporte ao usuário,
            instalação de software, manutenção em redes de computadores,
            auxiliar nas atividades do dia-a-dia, auxiliar no manuseio de
            sistemas, segmentação da rede e Infraestrutura.
          </CardDescription>
        </CardContainer>
